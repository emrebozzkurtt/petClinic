...
public class PetClinicRestControllerTests {
	...
	public void testGetOwnerById() {
		...
		MatcherAssert.assertThat(response.getStatusCodeValue(), Matchers.equalTo(500));
		MatcherAssert.assertThat(response.getBody().getFirstName(), Matchers.equalTo("Mustafa"));
	}
